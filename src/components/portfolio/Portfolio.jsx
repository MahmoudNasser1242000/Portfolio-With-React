        ...
        <div className='w-100'>
            <Container className="mx-auto">
                ...
                <div className='row gy-4 pb-5 pt-4'>
                    <Card img={"./assets/images/port1.png"} getImage={getImage}/>
                    <Card img={"./assets/images/port2.png"} getImage={getImage}/>
                    <Card img={"./assets/images/port3.png"} getImage={getImage}/>
                    <Card img={"./assets/images/port1.png"} getImage={getImage}/>
                    <Card img={"./assets/images/port2.png"} getImage={getImage}/>
                    <Card img={"./assets/images/port3.png"} getImage={getImage}/>
                </div>
